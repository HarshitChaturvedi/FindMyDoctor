...
%>
		...
		<button type="submit" formaction="ForgotPassDoctorProcess.jsp" class="btn btn-success">  Submit</button>&nbsp&nbsp
		</div><br/><br/><br/>
		<br/>
...
%>
			...
			<button type="submit" formaction="LoginRegisterDoctor.jsp" class="btn btn-info"> Back</button>
                        </form>
  <!--Fixed Footer-->
