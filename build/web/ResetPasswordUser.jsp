  ...
  <div class="container">
   ...
   <ul class="nav navbar-nav">
      ...
      <li><a href="HealthTips.jsp">Health Tips</a></li>
		...
		<div class="well" align="center"  style="color: Purple"><h2>Reset Password</h2></div>
		<%
...
%> 
		...
		<div class="form-group">
			...
			<div class="col-sm-8">
			<input type="password" class="form-control" name="cnf"/>
		</div></div>
		<div class="col-sm-offset-2 col-sm-8">
		<button type="submit" formaction="ResetPassProcessUser.jsp" class="btn btn-info"> Reset Password</button>
